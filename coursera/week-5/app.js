...
var result = dijkstra(1, 7, graph)["7"].length + ',' +
dijkstra(1, 37, graph)["37"].length + ',' +
dijkstra(1, 59, graph)["59"].length + ',' +
dijkstra(1, 82, graph)["82"].length + ',' +
dijkstra(1, 99, graph)["99"].length + ',' +
dijkstra(1, 115, graph)["115"].length + ',' +
dijkstra(1, 133, graph)["133"].length + ',' +
dijkstra(1, 165, graph)["165"].length + ',' +
dijkstra(1, 188, graph)["188"].length + ',' +
dijkstra(1, 197, graph)["197"].length;
